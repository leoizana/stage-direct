 ...
 */
final class Version20241127104737 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tbl_stage (id SERIAL NOT NULL, classe_eleve VARCHAR(255) NOT NULL, date_debut TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_fin TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, session VARCHAR(255) NOT NULL, themes TEXT NOT NULL, PRIMARY KEY(id))');
