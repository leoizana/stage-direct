...
final class Version20250307153241 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tbl_internship (id SERIAL NOT NULL, relation_id INT NOT NULL, classe_eleve VARCHAR(255) NOT NULL, date_debut TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_fin TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, session VARCHAR(255) NOT NULL, themes TEXT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE tbl_user ADD CONSTRAINT FK_38B383A1C32A47EE FOREIGN KEY (school_id) REFERENCES tbl_school (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tbl_user DROP CONSTRAINT FK_38B383A1C32A47EE');
