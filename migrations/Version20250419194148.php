...
final class Version20250419194148 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tbl_internship DROP INDEX IDX_7992FA9D979B1AD6');
        $this->addSql('ALTER TABLE tbl_internship DROP COLUMN company_id');
        $this->addSql('ALTER TABLE tbl_internship DROP COLUMN is_verified');
        $this->addSql('ALTER TABLE tbl_company DROP COLUMN is_verified');
    }
}
